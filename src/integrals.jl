...
Incomplete elliptic integral of the second kind, `E(φ | m)`, for angle `φ` and parameter `m`
"""
...
Complete elliptic integral of the second kind, `E(m) = E(π/2 | m)`, for parameter `m`
"""
...
Incomplete elliptic integral of the third kind, `Π(n; φ | m)`, for angle `φ` and parameter `m`
"""
...
Matlab compatible call, returns `(sn(u | m), cn(u | m), dn(u | m))`
"""
